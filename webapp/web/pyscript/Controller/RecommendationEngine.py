...
from web.pyscript.Controller.RestaurantManager import RestaurantManager
from web.pyscript.Controller.UserManager import UserManager
...
class RecommendationEngine(metaclass=Singleton):
    ...
    def getFoodRecommendationQueue(self, user):
        ...
        self._foodManager.refresh()
        self._foodPreferenceManager.refresh()
        self._restaurantManager.refresh()
